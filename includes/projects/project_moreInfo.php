...
if($check_projectInfo == $name)
{
	...
	echo '<div id="projectInfo_outerDiv">
			<div id="projectInfo_title">
				<img src="images/project/MoreInfoTitleBG.png" width="960" height="40" id="projectInfo_title_bg" alt="description_bg" />
				<div id="projectInfo_title_text">'.$name.'</div>
			</div> 
			<img src="'.$image.'" id="projectInfo_Image" alt="game_banner" />';
		if(!empty($prj_description))
		{				
			echo'<div id="projectInfo_Description_Div">
					<img src="images/project/MoreInfoTitleBG.png" width="960" height="100" id="projectInfo_Description_Bg"  alt="description_bg" />
	...
	echo '<div id="project_navigationOuterDiv">
			<form method="post">
				<input type="submit" name="updatesButton" value="Updates"/>
				<input type="submit" name="galleryButton" value="Gallery"/>
			</form>   	
		</div>';
	...
	if($page == 'Updates') 
	{
		...
		echo '<div id="project_outerDiv">';
		   ...
		   echo '<div class="project_div">
					<div class="project_video_div"><iframe width="500" height="294" src="https://www.youtube.com/embed/'.$videoExtension.'" frameborder="0" allowfullscreen></iframe></div>
	...
	if($page == 'Gallery') 
	{
		...
		{	
			...
			echo '<div id="gallery_outerDiv">';				
				...
				{
					if(!empty($row['Image']))
						echo '<div class="gallery_images"><a href="'.$row['Image'].'"><img src="'.$row['Image'].'" width="256" height="150" alt="in-game image"></a></div>';
						
					if(!empty($row['Image2']))	
						echo '<div class="gallery_images"><a href="'.$row['Image2'].'"><img src="'.$row['Image2'].'" width="256" height="150" alt="in-game image"></a></div>';
						
					if(!empty($row['Image3']))
						echo '<div class="gallery_images"><a href="'.$row['Image3'].'"><img src="'.$row['Image3'].'" width="256" height="150" alt="in-game image"></a></div>';
				}
			echo'<div class="float_push"></div></div>';
		}
	}
}
else
